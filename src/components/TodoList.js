...
import { fetchTodos, updateExistingTodo, deleteTodoById } from '../reducers/todo';
...
export default connect((state) => ({ todos: state.todo.todos }), { fetchTodos, updateExistingTodo, deleteTodoById })(
  TodoList
);
